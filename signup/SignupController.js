    ...
    onSubmitForm() {
        this.formElement.addEventListener("submit", (event) => {
            ...
            if (!arePasswordsEqual) {
                pubSub.publish(pubSub.TOPICS.SHOW_ERROR_NOTIFICATION, "Las contraseñas no coinciden");
                return;
            }
            ...
            if (!isPasswordValid) {
                pubSub.publish(pubSub.TOPICS.SHOW_ERROR_NOTIFICATION, "La contraseña debe tener solo numeros o letras");
                return;
            }
